...
int main() {
  ...
  WbDeviceTag ds_left = wb_robot_get_device("left ultrasonic sensor");   // sensor names must match your Webots model
  WbDeviceTag ds_right = wb_robot_get_device("right ultrasonic sensor");
  WbDeviceTag ds_front = wb_robot_get_device("front ultrasonic sensor");
